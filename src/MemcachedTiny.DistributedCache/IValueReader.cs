...
namespace MemcachedTiny.DistributedCache
{
    ...
    public interface IValueReader
    {
        ...
        void PrepareGet(IMemcachedClient memcachedClient);
        /// <summary>
        /// 准备读取
        /// </summary>
        /// <param name="memcachedClient">当前使用的客户端</param>
        ...
        /// <returns></returns>
        Task PrepareGetAsync(IMemcachedClient memcachedClient, CancellationToken token);
        /// <summary>
        /// 更新时间
        /// </summary>
        /// <param name="memcachedClient">当前使用的客户端</param>
        void Touch(IMemcachedClient memcachedClient);
        /// <summary>
        /// 更新时间
        /// </summary>
        /// <param name="memcachedClient">当前使用的客户端</param>
        /// <param name="token">任务取消令牌</param>
        /// <returns></returns>
        Task TouchAsync(IMemcachedClient memcachedClient, CancellationToken token);
    }
}